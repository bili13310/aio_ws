...
class Limo_wall_following:
    ...
    def LiDAR_scan(self):
        ...
        # 전방 디택팅 각도
        for i, data in enumerate(self.msg.ranges):
            if -5 < self.degrees[i] < 8 and 0 < self.msg.ranges[i] < 1.0:
    ...
    def maintain_direction(self):
        ...
        if self.DIRECTION == LEFT:
            angle1 = self.angle_distance(56)
            angle2 = self.angle_distance(57)
            print(angle1)
            print(angle2)
    ...
    def move_control(self):
        ...
        if self.condition == "forward":
            ...
            if self.DIRECTION == LEFT:
                self.angle = self.default_angle * 1
            elif self.DIRECTION == RIGHT:
                self.angle = (self.default_angle) * 1
    ...
    def obstacle_motion(self):
        ...
        turn_angle = angle_incre * blank_space / 14
